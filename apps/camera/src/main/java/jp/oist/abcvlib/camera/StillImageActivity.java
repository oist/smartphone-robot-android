...
public final class StillImageActivity extends AppCompatActivity {
    ...
    private static final String KEY_IMAGE_URI = "jp.oist.abcvlib.camera.KEY_IMAGE_URI";
    private static final String KEY_SELECTED_SIZE = "jp.oist.abcvlib.camera.KEY_SELECTED_SIZE";
