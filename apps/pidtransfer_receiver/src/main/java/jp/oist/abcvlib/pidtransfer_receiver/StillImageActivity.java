...
public final class StillImageActivity extends AppCompatActivity {
    ...
    private static final String KEY_IMAGE_URI = "jp.oist.abcvlib.pidtransfer_receiver.KEY_IMAGE_URI";
    private static final String KEY_SELECTED_SIZE = "jp.oist.abcvlib.pidtransfer_receiver.KEY_SELECTED_SIZE";
