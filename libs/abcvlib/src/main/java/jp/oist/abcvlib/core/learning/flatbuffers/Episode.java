...
public final class Episode extends Table {
  ...
  public jp.oist.abcvlib.core.learning.flatbuffers.TimeStep timesteps(int j) { return timesteps(new jp.oist.abcvlib.core.learning.flatbuffers.TimeStep(), j); }
  public jp.oist.abcvlib.core.learning.flatbuffers.TimeStep timesteps(jp.oist.abcvlib.core.learning.flatbuffers.TimeStep obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int timestepsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public jp.oist.abcvlib.core.learning.flatbuffers.TimeStep.Vector timestepsVector() { return timestepsVector(new jp.oist.abcvlib.core.learning.flatbuffers.TimeStep.Vector()); }
  public jp.oist.abcvlib.core.learning.flatbuffers.TimeStep.Vector timestepsVector(jp.oist.abcvlib.core.learning.flatbuffers.TimeStep.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
