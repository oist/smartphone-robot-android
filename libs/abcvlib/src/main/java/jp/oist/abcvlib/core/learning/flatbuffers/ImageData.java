...
public final class ImageData extends Table {
  ...
  public jp.oist.abcvlib.core.learning.flatbuffers.Image images(int j) { return images(new jp.oist.abcvlib.core.learning.flatbuffers.Image(), j); }
  public jp.oist.abcvlib.core.learning.flatbuffers.Image images(jp.oist.abcvlib.core.learning.flatbuffers.Image obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int imagesLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public jp.oist.abcvlib.core.learning.flatbuffers.Image.Vector imagesVector() { return imagesVector(new jp.oist.abcvlib.core.learning.flatbuffers.Image.Vector()); }
  public jp.oist.abcvlib.core.learning.flatbuffers.Image.Vector imagesVector(jp.oist.abcvlib.core.learning.flatbuffers.Image.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
