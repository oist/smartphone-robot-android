...
public final class Monster extends Table {
  ...
  public jp.oist.abcvlib.core.learning.flatbuffers.Vec3 pos() { return pos(new jp.oist.abcvlib.core.learning.flatbuffers.Vec3()); }
  public jp.oist.abcvlib.core.learning.flatbuffers.Vec3 pos(jp.oist.abcvlib.core.learning.flatbuffers.Vec3 obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public jp.oist.abcvlib.core.learning.flatbuffers.Weapon weapons(int j) { return weapons(new jp.oist.abcvlib.core.learning.flatbuffers.Weapon(), j); }
  public jp.oist.abcvlib.core.learning.flatbuffers.Weapon weapons(jp.oist.abcvlib.core.learning.flatbuffers.Weapon obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int weaponsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public jp.oist.abcvlib.core.learning.flatbuffers.Weapon.Vector weaponsVector() { return weaponsVector(new jp.oist.abcvlib.core.learning.flatbuffers.Weapon.Vector()); }
  public jp.oist.abcvlib.core.learning.flatbuffers.Weapon.Vector weaponsVector(jp.oist.abcvlib.core.learning.flatbuffers.Weapon.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public jp.oist.abcvlib.core.learning.flatbuffers.Vec3 path(int j) { return path(new jp.oist.abcvlib.core.learning.flatbuffers.Vec3(), j); }
  public jp.oist.abcvlib.core.learning.flatbuffers.Vec3 path(jp.oist.abcvlib.core.learning.flatbuffers.Vec3 obj, int j) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o) + j * 12, bb) : null; }
  public int pathLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public jp.oist.abcvlib.core.learning.flatbuffers.Vec3.Vector pathVector() { return pathVector(new jp.oist.abcvlib.core.learning.flatbuffers.Vec3.Vector()); }
  public jp.oist.abcvlib.core.learning.flatbuffers.Vec3.Vector pathVector(jp.oist.abcvlib.core.learning.flatbuffers.Vec3.Vector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), 12, bb) : null; }
